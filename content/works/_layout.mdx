...
<Container variant="wide">
  <div className="canopy-work--docband">
    <span>Environmental Impact Statement Collection</span>
    <span>National Environmental Policy Act Archive</span>
  </div>
</Container>
...
{/* ── Ornament ── */}
<Container>
  <div className="canopy-work--ornament">§</div>
</Container>
