...
export function Head() {
  return (
    <>
      ...
      />
      <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400;1,500;1,600&family=Lora:ital,wght@0,400;0,500;1,400;1,500&family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500&display=swap"
        rel="stylesheet"
      />
    </>
  );
...
export function App({children}) {
  return (
    <>
      ...
      <main>{children}</main>
      <CanopyFooter>
        <p>Environmental Impact Statement Collection · A Canopy IIIF Project</p>
      </CanopyFooter>
    </>
  );
}
